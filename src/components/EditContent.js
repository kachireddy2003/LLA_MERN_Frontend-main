...
function EditContent() {
    ...
    useEffect(() => {
        Axios.get(`lla-mern-backend-main.onrender.com/AdminRoute/updatecontent/${id}`)
            .then((res) => {
                if (res.status === 200) {
    ...
    const handleSubmit = () => {
        ...
        Axios.put(`https://lla-mern-backend-main.onrender.com/AdminRoute/updatecontent/${id}`, data)
            .then((res) => {
                if (res.status === 200) {
